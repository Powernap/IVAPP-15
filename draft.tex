...
\begin{figure}[!h]
  ...
  \caption{
	...
	%%
	The curvature angle is calculated using the top, bottom and middle point.
	%%
...
\begin{figure}[!h]
  ...
  \caption{
	...
	%%
	(b) Spine canal thickness is associated with herniated disks.
	%%
	(c) the spine canal shape can be used to characterize scoliosis and lordosis as well as the \emph{Cobb-Angles} \cite{Cobb}.
	%%
	}
