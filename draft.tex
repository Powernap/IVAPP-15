...
%%
We provide an IVA technique to compare classifiers with interactive \emph{decision tree quality plot}. %scatter plot visualizations.
%%
...
%%------------
\\\\
\noindent \textbf{Decision Tree Visualization Quality Plot Interaction.}
%%
