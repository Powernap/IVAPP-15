...
%%
\begin{equation}
error_{normalized} = \frac{error}{100 - \frac{1}{class number}}
\end{equation}
%%
...
%%
We however still want to be able to look display \emph{details-on-demand} \ref{shneiderman1996} and examinate a decision tree in detail.
%%
