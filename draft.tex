...
%%
Subjects experiencing \emph{pain in the last seven days} can also be predicted for this group using the same variables with a tree consisting of $8$ rules and an error of $0.35$
