...
%%
We provide an IVA technique to compare classifiers with a \emph{decision tree quality plot}. %scatter plot visualizations.
%%
...
%	(a) right: FEM aligned to an MRI data set.
	...
	%%
%	We extract the variables for each projection axis to assess their information gain.
	}
