...
Klemm et al. analyzed the variability of the lumbar spine data of 490 \texttt{SHIP-2} subjects \cite{Klemm2013VMV}.
%%
...
%Our work is based on data extracted in the same manner as described in this paper.
...
%Analyzing non-image data using clustering techniques 
