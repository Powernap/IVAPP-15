...
%%
Subject groups (a cohort) is analyzed to correlate lifestyle and medical variables with diseases.
%%
...
%% Approach
Our analysis is based on detection masks from a semi-automatic model based detection of 2,540 lumbar spines.
%%
...
%%
We make these trees comparable by introducing tree size and a classification error rate metrics.
%%
...
%%
The presented approach is a valuable extension to the interactive visual analysis of epidemiological data and not limited to image-parameter analysis.
}
